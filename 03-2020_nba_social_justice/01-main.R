...
dir_proj <- '03-2020_nba_social_justice'
msgs <- 
  here::here(dir_proj, 'data-raw', '2020-restart-nba-social-justice-jersey-messages.xlsx') %>% 
  readxl::read_excel() %>% 
  mutate(
    message = message %>% 
...
viz_msgs
ggsave(plot = viz_msgs, filename = here::here(dir_proj, '2020_nba_social_justice.png'), width = 10.5, height = 10.5, type = 'cairo')
