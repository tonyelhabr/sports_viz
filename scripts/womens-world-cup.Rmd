...
# https://data.fivethirtyeight.com/#womens-world-cup-2019
forecasts <- read.csv(here::here('data-raw', "wwc_forecasts.csv"), stringsAsFactors = FALSE)
...
forecasts$points <- as.integer(runif(192, min = 0, max = 6)) # added
forecasts <- forecasts[, c("team", "points", "group", rating_cols, group_cols, knockout_cols)]
# forecasts <- forecasts %>% as_tibble() # added
