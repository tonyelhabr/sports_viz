...
manu_color <- '#DA291C'
manu_tweets <- file.path(dir_proj, 'manu_tweets.csv') |> read_csv()
...
p <- player_counts |> 
  ...
  labs(
    title = glue::glue('Appearances in end-of-match <span style="color:#FBE122">@</span><span style="color:{manu_color}">ManUtd</span> score tweets'),
