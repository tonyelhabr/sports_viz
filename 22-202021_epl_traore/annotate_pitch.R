...
# Inspiration for changes to arc/circle: https://github.com/JoGall/soccermatics/blob/197e7a8aa1281f3299c1f34a3d0a70f3dbf64728/R/soccerPitch.R#L86
annotate_penalty_box <- function(colour, fill, spec, constant = 0.85) {
  midpoint <- pitch_center(spec)
